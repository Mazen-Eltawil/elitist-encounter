...
const Logo: React.FC<LogoProps> = ({
  ...
  return <Link to="/" className={`block ${className}`}>
      ...
      {variant === 'text' && <img src="/lovable-uploads/c530e800-51b1-4871-8440-1fe4d4c8b6a7.png" alt="Elitist Links" className="h-24 w-auto transition-all duration-500 object-contain" />}
