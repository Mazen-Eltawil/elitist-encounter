	...
	theme: {
		...
		extend: {
			...
			animation: {
				...
				'gold-shimmer': 'gold-shimmer 8s infinite ease-in-out',
				'border-glow': 'border-glow 3s infinite ease-in-out',
				'logo-shine': 'logo-shine 5s infinite ease-in-out',
				'slide-in-bottom': 'slide-in-bottom 0.7s ease-out forwards',
				'slide-in-right': 'slide-in-right 0.5s ease-out forwards',
			},
			backgroundImage: {
				'gold-gradient': 'linear-gradient(45deg, #D4AF37, #E5C76B, #D4AF37)',
				'dark-gradient': 'linear-gradient(to bottom, #0D0D0D, #1A1A1A)',
			},
		}
	},
